  ...
  <div class="layout" :class="{ 'layout-hide-text': spanLeft < 3 }">
    <Row type="flex">
      ...
      <i-col :span="spanRight">
          ...
          <div class="login-img">
            ...
            <Dropdown style="margin-left: 20px">
              ...
              <DropdownMenu slot="list">
                <DropdownItem @click.native="routeTo('login')"
                  >退出</DropdownItem
                >
              </DropdownMenu>
            </Dropdown>
        ...
        <div class="layout-copy">2016-2021 &copy; NSLab</div>
      </i-col>
    </Row>
  </div>
</template>
...
export default {
  ...
  mounted() {
    let userInfo = cacheUtils
      .localStorage(consts.USERINFO)
      .get(consts.USERINFO);
