  ...
  <div class="tools">
    <ul class="tools-ul">
      <a v-for="item in toolsList" :href="item.url" target="_blank">
        <Card>
          <Row>
            <Col span="6" class="col-img"
              ><img v-lazy="item.img" class="imgWidth imgs"
            /></Col>
    ...
    <Card>
      <p>
        给大家推荐这些工具类希望能够新欢，这些是工作中经常使用到，当然也会持续添加。
      </p>
      <p>
        如果朋友们发现有什么好用的好玩的，可以踊跃投稿私信我哦！邮箱
        shanyanwt@163.com
      </p>
    </Card>
  </div>
      ...
      toolsList: [
        {
          name: "vuejs",
          introduce:
            "Vue 是数据驱动框架。Vue 的核心库只关注视图层，不仅易于上手，还便于与第三方库或既有项目整合。",
        ...
        },
        {
          name: "cloudconvert",
          introduce:
            "一个在线可以把任何格式的文件转换为任何格式，当然没有那么牛逼啦，但还是很厉害的格式转换工具",
        ...
        },
        {
          ...
          img:
            "https://www.chuangkit.com/distweb/img/logo-colored-2019.11081299.svg",
        },
        {
          name: "weavesilk",
          introduce:
            "可以在随便划拉划拉的在线绘图工具，你什么也不会也可以画出精美的图案",
        ...
        },
        {
          name: "鬼畜小视频制作",
          introduce:
            "一个在线可以让图片跟着音乐点头的网站，动动嘴巴动动头，鬼畜视频",
