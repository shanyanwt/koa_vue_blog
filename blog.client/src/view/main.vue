		...
		<Layout>
			<Header>
				<Menu mode="horizontal" theme="dark" active-name="1">
					<div class="layout-logo" @click="routeTo('/')"><img class="logo" src="../static/img/logo.png" />
							...
							<Dropdown>
								...
								<template v-for="item in downMenu">
									<DropdownMenu slot="list">
										<DropdownItem @click.native="routeTo(item.url)">{{item.text}}</DropdownItem>
									</DropdownMenu>
								</template>
							</Dropdown>
							<div class="writing">
			...
			<Footer class="layout-footer-center footer aaa">
				...
				<p>
					...
					<a href="http://es6.ruanyifeng.com/?search=tmeplate&x=0&y=0#README" target="_blank"> ECMAScript 6 入门</a>
				</p>
				<p>
					<a>备案号：</a>2018-2019 &copy; 京ICP备18002635号
				</p>
...
<script>
	...
	export default {
		...
		methods: {
			...
			//页面滚动事件的实现
			menu() {
				this.scroll = window.pageYOffset || document.documentElement.scrollTop || document.body.scrollTop; //滚动的长度
